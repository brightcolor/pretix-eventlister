<?php
/**
 * Inline translations for German UI fallback.
 *
 * This file is intentionally PHP-based so we can ship translations
 * without requiring gettext tooling during local release builds.
 *
...
return array(
	...
	'Install or update the plugin in WordPress.'
		=> 'Plugin in WordPress installieren oder aktualisieren.',
	'Configure your pretix connection under Settings > Pretix Eventlister.'
		=> 'Unter Einstellungen > Pretix Eventlister die pretix-Zugangsdaten hinterlegen.',
